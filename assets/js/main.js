...
hoverChangeExperience(
  ".digitalhouse",
  `Trabalhei como desenvolvedor Full-stack de um projeto (CRM), em que eram abrangidos dashboards de vendas, comissionamentos, clientes, entradas. Utilizava PHP e Láravel, onde tive que aprender a utilizá-los. Também aprendi fundamentos da utilização de Bancos de dados SQL.`,
  "Full-Stack Developer",
  "Gildacred",
  "Nov 2022 - Fev 2023 (4 meses)"
);

hoverChangeExperience(
  ".zuplae",
  `Trabalhei desenvolvendo o meu primeiro negócio próprio no que seria um empreendimento de grande retorno. Atuei gerenciando equipes, entregas e logsísticas, bem como ter sido o desenvolvedor da marca das políticas de marketing e o desenvolvimento do site.`,
  "CEO, Desenvolvedor",
  "Lowpods",
  "Jan 2020 - Jan 2021 (12 meses)"
